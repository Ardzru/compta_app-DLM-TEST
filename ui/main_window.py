...
# ── Constantes typées pour éviter les warnings linter ────────────────────────
_BOTH: Literal["none", "x", "y", "both"] = "both"
_X:    Literal["none", "x", "y", "both"] = "x"
...
class MainWindow:
    ...
    def _style() -> None:
        ...
        s.configure("Title.TLabel", background="#f0f2f5",  font=("Segoe UI", 14, "bold"), foreground="#1a1a2e")
        s.configure("Sub.TLabel",   background="#f0f2f5",  font=("Segoe UI", 9),          foreground="#555555")
    ...
    def _build_home(self) -> None:
        ...
        frame.pack(fill=_BOTH, expand=True)  # ✅ Literal typé
        ...
        ttk.Separator(frame, orient="horizontal").pack(fill=_X, pady=12)  # ✅
    ...
    def _ouvrir_transform(self) -> None:
        for w in self.root.winfo_children():
            w.destroy()
    ...
    def _ouvrir_justification(self) -> None:
        for w in self.root.winfo_children():
            w.destroy()
        self.root.resizable(True, True)
        self.root.geometry("750x650")
